...
class Habit(db.Model):
    ...
    customers = db.relationship("Customer", secondary=customers_habits, back_populates="habits")

    @classmethod
    def habit_filter(cls, customer_id, user_id):
        sql_query = text("SELECT * FROM  habits WHERE customer_id = ':customer_id' and user_id=':user_id';")
